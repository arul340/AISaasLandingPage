      ...
      <div className="container">
        <SectionBorder>
          <SectionContent className="relative isolate overflow-hidden [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_90%,transparent)]">
            <div className="absolute -z-10 inset-0 bg-[radial-gradient(circle_farthest-corner,var(--color-fuchsia-900)_50%,var(--color-indigo-900)_75%,transparent)] [mask-image:linear-gradient(circle_farthest-side,black,transparent)]"></div>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold text-gray-100 text-center leading-tight">
              ...
              <span className="relative">
                <span>Sphereal</span>
                <span
                  className="absolute w-full  h-2 left-0 top-full -translate-y-1/2 bg-[linear-gradient(to_right,var(--color-amber-300),var(--color-teal-300),var(--color-violet-400),var(--color-fuchsia-400))]"
                  style={{
            ...
            <p className="text-center text-lg md:text:xl mt-8 max-w-3xl mx-auto">
              Harness power of AI with Sphereal. Elevate your productivity and
              streamline your workflow with our cutting-edge AI chat platfrom
            </p>
            ...
            <div className="relative isolate max-w-5xl mx-auto">
              ...
              <div className="absolute  left-0 z-10 top-[30%] -translate-x-10 hidden lg:block">
                ...
                >
                  ...
                  <div className="text-gray-400 text-right text-sm font-semibold">
                    1m ago
                  </div>
                </motion.div>
              </div>
              ...
              <div className="mt-16 rounded-2xl border-2 overflow-hidden border-gradient relative flex">
